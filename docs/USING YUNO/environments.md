...
metadata:
  title: Environments
  description: >-
    Yuno offers Test Mode (Sandbox) and Live Mode (Production). Use Test Mode
    for testing; switch to Live Mode when you are ready for real transactions.
  robots: index
next:
  description: ''
---
This guide explains how **Test Mode** and **Live Mode** work in the Yuno dashboard and how to switch between them. For API base URLs and credentials per environment, see the [API Environments](https://docs.y.uno/reference/api-environments) reference.
...
* [API Environments](https://docs.y.uno/reference/api-environments) — Base URLs, timeouts, and API behaviour per environment.
* [Developers credentials](https://docs.y.uno/docs/developers-credentials) — Where to find API keys for Test and Live.

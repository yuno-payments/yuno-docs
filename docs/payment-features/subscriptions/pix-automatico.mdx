...
* **Plan without a trial:** the payment is the first charge, at the plan's price. When the customer
  ...
  If the first payment is refused or expires, the subscription stays `CREATED` and is never billed;
  cancel it with [Cancel Subscription](/reference/subscriptions/cancel-subscription).

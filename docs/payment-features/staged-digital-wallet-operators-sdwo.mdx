...
| `account_funding.beneficiary.country` | Required | ISO country code of the account holder. |
...
| `account_funding.sender.country` | Required | ISO country code of the person funding the operation. |

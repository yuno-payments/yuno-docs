...
To ensure precision across different currencies, Yuno uses the `HALF_EVEN` rounding strategy (also known as Bankers' Rounding) for all automatic calculations.

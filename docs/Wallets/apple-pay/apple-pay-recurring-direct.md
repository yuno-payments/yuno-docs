...
Recurring Apple Pay payments consist of two distinct transaction types:

### Customer Initiated Transaction (CIT)

The **CIT** is the first transaction where the customer actively participates and authorizes the payment. This transaction:

- Requires customer interaction and authorization
- Sets up the recurring payment agreement
- Generates a payment token for future use
- Must include `vault_on_success: true` to enable token generation

### Merchant Initiated Transaction (MIT)

**MIT** transactions are subsequent payments processed without customer interaction. These transactions:

- Use the token generated during the CIT
- Do not require customer authorization
- Are processed automatically by the merchant
- Include stored credentials information

## Customer Initiated Transaction (CIT)

For the first transaction where the customer interacts and authorizes the recurring payment setup:
...
For subsequent payments processed automatically without customer interaction:
...
- [Dashboard Setup and Configuration](doc:setup-configuration) - Required setup steps

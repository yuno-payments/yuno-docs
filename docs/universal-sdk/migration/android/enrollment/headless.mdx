...
- [Lite enrollment](/docs/universal-sdk/migration/android/enrollment/lite). SDK presents the form for you.
- [Render enrollment](/docs/universal-sdk/migration/android/enrollment/render). Embed the SDK's form yourself.
- [Migration / Headless (payment)](/docs/universal-sdk/migration/android/payment/headless). The payment counterpart for the Headless sub-mode.

...
- [Transaction lifecycle](/docs/how-yuno-works/how-yuno-payment-flow-works). When external redirects can occur.
- [`onStatus`](/docs/universal-sdk/controllers/on-status). Receives the final status of the transaction.

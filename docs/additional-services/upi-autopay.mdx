---
title: "UPI Autopay"
description: "Set up UPI Autopay recurring debits with mandates and pre-debit notifications."
---
...
Implement Autopay through the `stored_credentials` field available in endpoints like [Create payment](/reference/payments/create-payment). The full path for create payments is `payment_method.detail.detail.bank_transfer.stored_credentials`.

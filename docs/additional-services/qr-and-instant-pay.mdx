...
description: "Charge and enroll customers for recurring Pix payments with a single scannable QR code."
---
...
As [mentioned before](/docs/additional-services/qr-and-instant-pay), have in mind that the information defined in the subscription creation will restrict the dates and values to be used for future payments.

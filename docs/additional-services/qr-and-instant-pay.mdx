...
As defined by the central bank, payments must be created within a **schedule window of 10 to 2 days before the scheduled billing date**. Use the `subscription_code` to identify the recurrence in the [payment creation](/reference/create-payment#/).

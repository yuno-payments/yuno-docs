...
The merchant can use the currency conversion service of an external provider and send the corresponding information directly in the payment in Yuno. To use this, contact your technical account manager to make sure that the information is set properly.

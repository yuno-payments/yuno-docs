...
description: "Set up your Yuno account, connection, routing, payment methods, and API credentials."
---
...
<Frame>![Account creation process](/images/reference/step-1-set-up-your-account/image1.png)</Frame>
...
Now that you've completed the dashboard setup and obtained your API credentials, proceed to [Create your first payment](/docs/step-2-your-first-payment) to continue with the integration guide.
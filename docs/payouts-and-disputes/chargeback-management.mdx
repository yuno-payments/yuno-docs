...
<iframe
  src="https://writechoiceorg.github.io/yuno-diagrams-public/diagrams/payouts-and-disputes/chargeback-management/chargeback-workflow.html"
  style={{ width: "100%", aspectRatio: "1540 / 874" }}
  frameBorder="0"
  allow="fullscreen"
  allowFullScreen
/>
...
<Frame><img src="/images/reference/chargeback-management/image2.png" /></Frame>

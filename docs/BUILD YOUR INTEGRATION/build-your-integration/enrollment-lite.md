...
Begin by creating a customer. After creating the customer, you can enroll payment methods to their account. If a customer `id` from a previous customer creation already exists, you may skip this step.

Use the [Create Customer](ref:create-customer) endpoint to create new customers and obtain the customer `id`. This customer `id` will be used in the subsequent steps.

...
The Lite SDK lets you enroll any payment method to your customer account by following the enrollment workflow described on this page. However, if you want to save cards, you can do it while your customer pays. Access [Lite SDK (Payment)](doc:lite-sdk-payment#enroll-a-credit-card-while-paying) for additional information.

...
<Frame><img src="/images/reference/insights/image1.png" alt="Insights Overview tab with the Add filters panel open, showing filter categories like Card brand and Country, and a list of countries with checkboxes for selection" /></Frame>
...
<Frame><img src="/images/reference/insights/image2.png" alt="Top merchant advisory codes list showing percentages such as Try again later and Do not try again, next to a Daily top merchant advisory codes line chart showing their trends over time" /></Frame>
## Fraud insights

...
<Frame><img src="/images/reference/payments/image1.png" alt="Payments table in the Yuno dashboard showing payment ID, order ID, status, sub status, amount, provider, and payment method columns for a list of transactions" /></Frame>

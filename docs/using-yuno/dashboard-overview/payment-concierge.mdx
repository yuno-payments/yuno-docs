...
The Payment Concierge section within the dashboard sets up an AI agent that works like a payments analyst on your team, one that sees your entire payment stack and works from wherever your team already does: Slack, WhatsApp, or Telegram. It's available 24/7, so you can ask anything, anytime. For example:
...
<Frame><img src="/images/reference/payment-concierge/request-access.png" alt="Request access dialog for Payment Concierge with fields for primary communication channel and desired activation date, and a checkbox to agree to the Terms and Conditions" /></Frame>
...
<Frame><img src="/images/reference/payment-concierge/briefing-configuration.png" alt="Briefing configuration tab showing a briefing card with Active toggle, Frequency, Preferred language, and Delivery time fields, a content editor, and suggestion buttons for report templates" /></Frame>
...
<Frame><img src="/images/reference/payment-concierge/communication-channels.png" alt="Communication channels tab with cards for Slack, WhatsApp, and Telegram, each showing fields for groups or channels and contacts for direct messages" /></Frame>

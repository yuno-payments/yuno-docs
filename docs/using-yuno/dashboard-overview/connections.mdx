...
<Frame><img src="/images/reference/connections/image1.png" alt="Connections list in the dashboard showing providers such as Adyen, Nuvei, NuPay, d-Local, Stripe, and Unlimint, each with a connection name, payment methods, and status like Active, Paused, or Pending" /></Frame>
...
<Frame><img src="/images/reference/connections/image2.png" alt="Add d-Local connection screen showing step 1 of 3, Set up credentials, with fields for name, X-Login, X-Trans-Key, secret key, and options for custom expiration, 3DS credentials, and installments" /></Frame>

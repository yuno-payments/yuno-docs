...
<Frame><img src="/images/reference/checkout-builder/image7.png" alt="Payment method settings three-dots menu open on BACS Direct Debit, showing Edit name and logo, Set Conditions, Set Required fields, Set authorization text, and Copy to other accounts options" /></Frame>
...
<Frame><img src="/images/reference/checkout-builder/image8.png" alt="Debit authorization text drawer for BACS Direct Debit, showing the Show authorization text (rendered by Yuno) toggle turned on" /></Frame>

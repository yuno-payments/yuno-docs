...
<Frame>![Create payment link panel in the Yuno dashboard showing basic info fields and currency selection](/images/reference/payment-links/image1.png)</Frame>
...
<Frame><img src="/images/reference/payment-links/image3.png" alt="Payment links list in the Yuno dashboard with the options menu open, showing Share payment link, View details, and Disable" /></Frame>

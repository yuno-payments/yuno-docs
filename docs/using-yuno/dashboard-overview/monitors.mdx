---
title: "Monitors"
description: "Detect approval-rate anomalies and automatically redirect traffic to fallback providers."
---
...
<Frame><img src="/images/reference/monitors/image1.png" /></Frame>
## Configure a monitor

...
<Frame><img src="/images/reference/monitors/image1.png" alt="Diagram of five traffic-redirection scenarios between dLocal, Unlimint, and Nuvei, showing approval-rate percentages for each provider and the resulting alerts as traffic shifts to whichever provider has the highest rate" /></Frame>
## Configure a monitor

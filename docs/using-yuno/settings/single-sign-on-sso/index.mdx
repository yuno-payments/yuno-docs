...
<Frame><img src="/images/reference/single-sign-on-sso/sso-tab-overview.png" alt="Security page in the Yuno dashboard showing the Single Sign-On (SSO) tab with Domain Verification and Single Sign-On cards, both showing verified and active status" /></Frame>
...
<Steps>
  <Step title="Verify your organization's domain">
    ...
    <Frame><img src="/images/reference/single-sign-on-sso/sso-domain-verification-portal.png" alt="Yuno domain verification portal with a field to enter your organization's domain and a Continue button" /></Frame>
  ...
  <Step title="Configure your SSO connection">
    ...
    <Frame><img src="/images/reference/single-sign-on-sso/sso-connection-activated.png" alt="Configure Single Sign-On portal confirming connection activated, showing connection details: identity provider Google SAML, domain y.uno, and external domains not allowed" /></Frame>

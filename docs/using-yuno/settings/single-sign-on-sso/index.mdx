...
<Steps>
  <Step title="Access the security section">
  ...
  <Step title="Set up SSO">
    ...
    <Frame><img src="/images/reference/single-sign-on-sso/image1.png" /></Frame>
  </Step>
  ...
  <Step title="Finalize the configuration in Yuno">
...
<Frame><img src="/images/reference/single-sign-on-sso/image2.png" /></Frame>

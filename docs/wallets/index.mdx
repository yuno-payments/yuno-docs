...
description: "Lists the wallet connections available on Yuno, including Apple Pay, Google Pay, Samsung Pay, Click to Pay, and NuPay."
---
...
<Columns cols={3}>
  ...
  <Card title="Samsung Pay" icon="https://icons.prod.y.uno/samsungpay_logosimbolo.png" href="/docs/wallets/samsung-pay" />

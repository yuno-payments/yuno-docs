...
Samsung Pay is available as an express wallet button in the **Web SDK** (since SDK 1.10.9). When a shopper taps the Samsung Pay button, the SDK loads Samsung's Web Checkout SDK, opens the Samsung payment sheet, and forwards the tokenised payment credential to Yuno for authorisation.

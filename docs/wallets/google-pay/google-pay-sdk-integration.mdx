...
description: "Integrate Google Pay using the Yuno SDK to handle the button, payment sheet, and token."
---
...
* Yuno SDK integrated in your application ([Web](/docs/sdks/resources/references/web), [Android](/docs/sdks/resources/references/android), or [iOS](/docs/sdks/resources/references/ios))

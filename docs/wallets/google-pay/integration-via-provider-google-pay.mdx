...
description: "Process Google Pay where your provider handles token decryption, keeping card data off Yuno."
---
...
<Frame><img src="/images/reference/integration-via-provider-google-pay/image1.png" /></Frame>
...
1. First, integrate [Yuno's SDK](/docs/sdks/full-checkout/android-payments) into your app to ensure a smooth connection between your application and Yuno's platform.
...
<Frame><img src="/images/reference/integration-via-provider-google-pay/image2.png" /></Frame>

...
description: "Enable a direct wallet experience on VTEX checkout and unlock Apple Pay and Google Pay installments."
---
...
This integration also unlocks optional **installments for Apple Pay and Google Pay**.
...
<Steps>
  <Step title="Create a Google Pay installment plan">
    ...
    <Warning>
      ...
      installments on both wallets needs one set of plans per wallet.
    </Warning>
  </Step>
  <Step title="Check the plan in the list">

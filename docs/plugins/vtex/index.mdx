---
title: "VTEX"
description: "Accept payments inside VTEX storefronts using Yuno's PCI-compliant orchestration plugin."
---
...
<Frame>![](/images/reference/vtex/image1.png)</Frame>
...
1. A VTEX store.\
   ...
   2. Application Token: a productive public key generated when the Yuno account became productive.
2. A Yuno account.\
   If you don't have a Yuno account, sign up at the [Yuno Merchant Dashboard](https://auth.y.uno/u/signup). You will use your Account ID, Public API Key, and Private API Key from your Yuno account. Access the [Developers](/docs/developers-credentials) tab on the Yuno dashboard to access your credentials.

Once you have this information, you can register the Yuno plugin affiliation. Follow the steps outlined in the [Configure Yuno as Provider](/docs/configure-yuno-as-provider) page. After completing the configuration processes, you'll enable your clients on VTEX to access the Yuno checkout to make payments on their orders.
...
<Frame>![](/images/reference/vtex/image2.png)</Frame>
...
<Frame>![](/images/reference/vtex/image3.png)</Frame>
...
<Frame>![](/images/reference/vtex/image4.png)</Frame>
...
4. <Frame>![](/images/reference/vtex/image5.png)</Frame>
...
<Frame>![](/images/reference/vtex/image6.png)</Frame>
...
description: "Connect your VTEX store to Yuno and configure offered payment methods as a provider."
---
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image1.png" /></Frame>

3. Search for **Yuno** on the dialog and select the **Yuno** option on the results.

<Frame><img src="/images/reference/configure-yuno-as-provider/image2.png" /></Frame>
...
| **Account\_ID**                             | The Yuno `account_id`. You can find this information in the [Yuno dashboard](https://dashboard.y.uno/developers). For additional information, see [Developers (Credentials)](/docs/developers-credentials).                                                             |
| **Public API Key**                          | The Yuno `public-api-key`. You can find this information in the Yuno dashboard. For additional information, see [Developers (Credentials)](/docs/developers-credentials).                                                                                               |
| **Private Secret Key**                      | The Yuno `private-secret-key`. You can find this information in the Yuno dashboard. For additional information, see [Developers (Credentials)](/docs/developers-credentials).                                                                                           |
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image3.png" /></Frame>
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image4.png" /></Frame>
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image5.png" /></Frame>
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image6.png" /></Frame>
...
<Frame><img src="/images/reference/configure-yuno-as-provider/image7.png" /></Frame>

Once you start receiving payments in VTEX with Yuno, you will be able to see all the information related to the transactions in your [Yuno dashboard](/docs/payments) as a regular payment.

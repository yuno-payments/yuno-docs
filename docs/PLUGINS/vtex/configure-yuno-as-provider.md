...
| **Main account app key** | VTEX application key from your main VTEX account. For additional information on accessing it, see [Generating internal application keys](https://help.vtex.com/tutorial/application-keys--2iffYzlvvz4BDMr6WGUtet#generating-internal-application-keys). |
| **Main account app token** | VTEX application token from your main VTEX account, paired with the Main account app key. You can find it when [Generating internal application keys](https://help.vtex.com/tutorial/application-keys--2iffYzlvvz4BDMr6WGUtet#generating-internal-application-keys). |
| **Main account name**    | The main VTEX account name (`accountName`) that owns these credentials. Use the exact account name as it appears in VTEX Admin. |

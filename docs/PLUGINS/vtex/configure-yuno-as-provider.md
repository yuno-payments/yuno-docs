...
| **VTEX IO orderPlaced page URL**           | To prevent [Known Issue 786685](https://help.vtex.com/known-issues/shopper-is-redirect-to-gatewaycallbackordergroupsuccess-instead-of-placeorder-page), we recommend setting this field to the 'Order Placed' URL (e.g., `https://mystore.com/checkout/orderPlaced`). |

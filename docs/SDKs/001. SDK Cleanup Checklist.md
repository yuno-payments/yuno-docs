...
Follow the style guide "docs/SDKs/002. Style Guide for SDK Files.md" on each page on the checklist "docs/SDKs/001. SDK Cleanup Checklist.md":
- Always adhere to the structure style specified in docs/SDKs/web-sdk-integrations/sdk-v12/full-sdk-v12.md.

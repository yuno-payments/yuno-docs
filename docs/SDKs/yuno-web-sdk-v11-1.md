...
For detailed information about webview integration, especially for Mercado Pago Checkout Pro, see the [Mercado Pago Checkout Pro webview integration](doc:complementary-features-full-sdk#mercado-pago-checkout-pro-webview-integration) section in the complementary features documentation.

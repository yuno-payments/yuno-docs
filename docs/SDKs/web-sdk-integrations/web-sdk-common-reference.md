...
metadata:
  title: Web SDK Common Reference
  description: >-
    Common integration methods and optimization techniques for Yuno Web SDKs
  robots: index
next:
  description: ''
---

This page contains common integration methods and optimization techniques that apply to all Yuno Web SDKs (Full SDK, Lite SDK, and Headless SDK).

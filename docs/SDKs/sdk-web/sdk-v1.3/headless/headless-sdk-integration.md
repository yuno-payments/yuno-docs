...
next:
  description: ''
---
Yuno's **Headless SDK** gives you full control over the checkout UX and UI without requiring you to be PCI-compliant. With Headless SDK, you can make card payments or enroll card information into your customers' accounts. Access the [Headless SDK (Enrollment)](doc:headless-sdk-enrollment-steps) for more information. This page covers the payment operation. Below you can check the guides available.

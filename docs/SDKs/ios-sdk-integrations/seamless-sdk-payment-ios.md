...
| `countryCode`     | This parameter determines the country for which the payment process is being configured. The complete list of supported countries and their codes is available on the [Country coverage](../docs/country-coverage-yuno-sdk) page.                                                                                                                                                                                                                                                                                                                                                                       |

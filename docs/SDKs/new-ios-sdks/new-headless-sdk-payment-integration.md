---
title: New - Headless SDK Payment Integration
deprecated: false
hidden: true
metadata:
  robots: index
...
>
> For most use cases, we recommend the [iOS SDK](../ios-sdk-payment-integration) with pre-built UI components. Use Headless SDK only when you need complete control over the payment UI and are comfortable handling all form validations yourself.

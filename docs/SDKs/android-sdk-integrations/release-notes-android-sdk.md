...
| Version   | Changes                                                                                                                                                                     |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 9.9.9     | 👨‍🔧 Fix: Corrección de crash al inicializar el SDK en Android 13. Validación incorrecta de tarjetas AMEX en modo lite. Error en la navegación después de completar 3DS challenge. 💯 Improve: Optimización del rendimiento en formularios de pago. Mejora en el manejo de errores de red. Actualización de dependencias de seguridad. Refactor de la arquitectura de vistas en Compose. 🆕 New: Soporte para Apple Pay en dispositivos compatibles. Integración con nuevo proveedor de pagos XYZ. Modo oscuro automático basado en configuración del sistema. Nuevo callback para tracking de eventos analíticos. Soporte para pagos recurrentes y suscripciones.  |

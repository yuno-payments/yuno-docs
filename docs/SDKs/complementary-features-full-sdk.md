...
* [Mercado Pago Checkout Pro webview integration](doc:complementary-features-full-sdk#mercado-pago-checkout-pro-webview-integration)

## Mercado Pago Checkout Pro webview integration

**Special Exception**: For payment methods that require merchant-side action in webviews (specifically Mercado Pago Checkout Pro - currently the only exception of this type), the `await yuno.continuePayment()` method will return either an object with the following structure or null:
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Enum value that identifies the payment method type. For Mercado Pago Checkout Pro webview integration, this will always be `'MERCADO_PAGO_CHECKOUT_PRO'`.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        URL to be redirected to finish the payment. This is the initial URL where the payment process begins in the webview.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        URL to be redirected after the payment was successful. The webview will navigate to this URL when the payment completes successfully.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        URL to be redirected after the payment was not successful. The webview will navigate to this URL when the payment fails or encounters an error.
      </td>
    </tr>
  </tbody>
</Table>

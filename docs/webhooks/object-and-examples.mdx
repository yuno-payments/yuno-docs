...
The JSON attributes for Yuno webhooks are listed below. See [Events and Triggers](/docs/webhooks/events) for the trigger field that selects each event.
...
<Columns cols={4}>
  <Card title="Payment Webhook V2" href="#payment-webhook-v2" arrow/>

  <Card title="Payment Webhook V1" href="#payment-webhook-v1" arrow/>

  <Card title="Chargeback Webhook V2" href="#chargeback-webhook-v2" arrow/>

  <Card title="Chargeback Webhook V1" href="#chargeback-webhook-v1" arrow/>

  <Card title="Enrollment" href="#enrollment" arrow/>

  <Card title="Payouts" href="#payouts" arrow/>

  <Card title="Subscriptions" href="#subscriptions" arrow/>

  <Card title="Onboardings" href="#onboardings" arrow/>

  <Card title="Refunds" href="#refunds" arrow/>

  <Card title="Marketplace Split Transfers" href="#marketplace-split-transfers" arrow/>

  <Card title="HMAC - Authorization" href="#hmac---authorization" arrow/>
</Columns>
...
Sent when a pre-chargeback notice or fraud alert is received for a payment, ahead of a full chargeback. Currently sent to any webhook with at least one `payment_triggers` value, regardless of whether `PRECHARGEBACK` is selected; a dedicated trigger gate is planned for a future release.
...
```json
{
  ...
  "data": {
    "payment": {
      "id": "8f3a1b6c-4d2e-4f8a-9b1c-7e5d3a2f6b04",
      "account_id": "2c05976d-1234-1234-1234-6421883de48d",
      "description": "Order 12578185913914",
      "country": "BR",
      "status": "SUCCEEDED",
      "sub_status": "APPROVED",
      "order_id": "ORDER-12578185913914",
      "merchant_order_id": "ORDER-12578185913914",
      "created_at": "2026-07-11T05:04:49.855791Z",
      "updated_at": "2026-08-17T16:32:03.145543Z",
      "idempotency_key": "4a6f2d18-9b73-4c51-a2e9-6d3b8f1c07a4",
      "amount": {
        "currency": "BRL",
        "value": 24.9,
        "refunded": 0.0,
      ...
      "fraud_screening": null,
      "transactions": {
        "id": "3d5e8c92-1f47-4a63-b8d0-5c2a9e7f14b6",
        "type": "PRE_CHARGEBACK",
        "status": "CREATED",
        "category": "CARD",
        "amount": 24.9,
        "provider_id": "ADYEN",
        "response_code": "ACTION_REQUIRED",
        "merchant_reference": "ORDER-12578185913914",
        "response_message": "Chargeback or Inquiry received. Decision or documentation must be provided",
        "reason": "FRAUDULENT",
        "description": "webhook transaction",
        "created_at": "2026-08-17T16:32:03.075632Z",
        "updated_at": "2026-08-17T16:32:03.103778Z",
        "provider": { "provider_transaction_id": "PROVIDER_CASE_ID" },
        "provider_data": {
          "id": "ADYEN",
          "transaction_id": "PROVIDER_CASE_ID",
          "account_id": "merchant_account_name",
        ...
        "connection_data": { "id": "6c4b2f79-8e13-4d5a-9f27-0a3e6b8d51c9", "name": "connection_name" }
      }
    }
  }
}
...
The next JSON object presents an example of a data structure related to an enrollment event.
...
The next JSON object presents an example of a data structure related to a payout event.
...
{
  "type": "report",
  "type_event": "report.update",
  "account_id": "2c05976d-1234-1234-1234-6421883de48d",
  "retry": 0,
  "version": 2,
  "data": {
    "report_id": "7b1c9d3e-5a24-4f68-9c02-3e8d1f6a4b57",
    "organization_code": "9f2e1a44-3c7b-4d15-8e60-1b4a7c9d2f88",
    "account_code": "2c05976d-1234-1234-1234-6421883de48d",
    "type": "TRANSACTIONS",
    "s3_link": "reports/ON_DEMAND/TRANSACTIONS/date=2026-08-17/organization_code=9f2e1a44-3c7b-4d15-8e60-1b4a7c9d2f88/report=7b1c9d3e-5a24-4f68-9c02-3e8d1f6a4b57/7b1c9d3e-5a24-4f68-9c02-3e8d1f6a4b57.csv",
    "merchant_reference_id": "",
    "start_date": "2026-08-01T03:00:00Z",
    "end_date": "2026-08-17T07:30:00Z",
    "created_at": "2026-08-17T07:33:04.372231Z",
    "updated_at": "2026-08-17T07:35:18.49869Z",
    "status": "SUCCEEDED",
    "user_code": ""
  }
}
...
The next JSON object presents an example of a data structure related to a `subscription.create` event.
...
The next JSON object presents an example of a data structure related to an onboarding event, in this case `onboarding.error`.
...
Sent when a marketplace split transfer completes successfully.
...
Sent when a marketplace split transfer reversal completes successfully.
...
The next JSON object presents an example of a data structure related to a `payment.refund` event.
...
The next example shows a raw webhook request with the `x-hmac-signature` header Yuno includes when HMAC authentication is enabled.

...
When a promotion was applied, the payment in the webhook carries `promotion` next to `amount`, with the same fields as the payment response. It's absent when no promotion applied. See [Promotions](/docs/payment-features/promotions) and [The Payment Object](/reference/payments/the-payment-object) for every field.
    ...
    "data": {
        "payment": {
            ...
            "promotion": {
                ...
                "charge_amount": { "currency": "ARS", "value": 22500 }
            }
        }
    }
}
...
```json
{
   "payment":{
      ...
      "promotion":{
         ...
         "charge_amount":{ "currency":"ARS", "value":22500.0 }
      }
   }
}
```

...
When a promotion was applied, the payment in the webhook carries `applied_promotion` next to `amount`, and the promotion's entry as the last element of `additional_data.order.discounts`, with the same fields as the payment response. It's absent when no promotion applied. See [Promotions](/docs/payment-features/promotions) and [The Payment Object](/reference/payments/the-payment-object) for every field.

The promotion-related part of the payload:
    ...
    "data": {
        "payment": {
            ...
            "applied_promotion": {
                ...
                "original_amount": { "currency": "ARS", "value": 25000 },
                "discount_amount": { "currency": "ARS", "value": 2500 },
                "charged_amount": { "currency": "ARS", "value": 22500 }
            },
            "additional_data": {
                "order": {
                    "discounts": [
...
```json
{
   "payment":{
      ...
      "applied_promotion":{
         ...
         "quote_id":"qte_0d91f7ac3b2e",
         "discount":{ "type":"PERCENTAGE", "value":10 },
         "original_amount":{ "currency":"ARS", "value":25000.0 },
         "discount_amount":{ "currency":"ARS", "value":2500.0 },
         "charged_amount":{ "currency":"ARS", "value":22500.0 }
      },
      "additional_data":{
         "order":{
            "discounts":[

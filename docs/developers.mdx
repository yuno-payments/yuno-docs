...
New to Yuno? Start with [Get started](/docs/overview) — it walks through account setup and your first payment. Come back here for named entry points into the API, SDKs, and MCP server.
...
Machine-readable skill definitions that let coding agents discover what Yuno does and how to call it, published on the [agent-skills discovery convention](https://docs.y.uno/.well-known/agent-skills/index.json):

| Resource | URL |
| --- | --- |
| **Yuno skill definition** | [https://docs.y.uno/skill.md](https://docs.y.uno/skill.md) |
| **Agent-skills index** | [https://docs.y.uno/.well-known/agent-skills/index.json](https://docs.y.uno/.well-known/agent-skills/index.json) |

Both are generated from these docs, so they track the published reference rather than being maintained by hand.
...
1. Read this page, the [Yuno skill definition](https://docs.y.uno/skill.md), and [llms.txt](https://docs.y.uno/llms.txt)

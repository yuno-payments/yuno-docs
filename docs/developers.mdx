...
Machine-readable OpenAPI 3.1 for the Yuno Payments API, aggregated from the same per-operation specs that power the API reference (225 operations across payments, customers, checkout, subscriptions, payouts, banking connectivity, and more):
...
| Compact spec (core paths, kept for compatibility) | [https://docs.y.uno/openapi/yuno-api-v1.yaml](https://docs.y.uno/openapi/yuno-api-v1.yaml) |

...
<Frame><img src="/images/reference/network-tokens/image1.png" /></Frame>
...
<Frame><img src="/images/reference/network-tokens/image2.png" /></Frame>
...
| `holder_name`                   | string  | Cardholder's full name as it appears on the token (MAX 255; MIN 2) - only available for PCI certified merchants                                                                                          |

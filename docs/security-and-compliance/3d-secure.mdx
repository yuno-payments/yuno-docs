...
<Frame>![](/images/reference/3d-secure/image1.png)</Frame>
...
<Columns cols={3}>
  <Card horizontal title="Visa" icon="https://icons.prod.y.uno/visa_logosimbolo.png" />

  <Card horizontal title="Mastercard" icon="https://icons.prod.y.uno/mastercard_logosimbolo.png" />

  <Card horizontal title="American Express" icon="https://icons.prod.y.uno/amex_logosimbolo.png" />

  <Card horizontal title="JCB" icon="https://icons.prod.y.uno/jcb_logosimbolo.png" />

  <Card horizontal title="Diners Club" icon="https://icons.prod.y.uno/dinnersclub_logosimbolo.png" />

  <Card horizontal title="UnionPay" icon="https://icons.prod.y.uno/unionpay_logosimbolo.png" />

  <Card horizontal title="Cartes Bancaires" icon="https://icons.prod.y.uno/cartabancaire_logosimbolo.png" />
</Columns>
</div>
...
<Frame>![](/images/reference/3d-secure/image2.png)</Frame>
...
<Note>
  **Yuno 3DS challenge experience (web SDK)**: on web, when you call `getThreeDSecureChallenge` and open the returned URL with `embedded=true`, the challenge is presented in an iFrame instead of a full-page redirect, on both desktop and mobile web. This reduces drop-off compared to redirecting to a separate URL, and is opt-in: if you omit `embedded=true`, the challenge opens in a new tab instead. See [Step 6](/docs/sdks/headless-web/payment#step-6-get-the-3ds-challenge-url) for the implementation details.

  This applies to Yuno's web 3DS provider only. Native mobile apps already run the challenge in-app using Netcetera's native 3DS SDKs, see the [iOS](/docs/sdks/external-native-modules/netcetera-3ds-ios) and [Android](/docs/sdks/external-native-modules/netcetera-3ds-android) guides.
</Note>

...
├── Web SDKs (Level 1)
│   ├── Yuno Web SDK v1.1 (Level 2)
│   ├── Full Web SDK (Level 2)
│   │   ├── Full Web SDK v1.3 (Level 3)
│   │   ├── Full Web SDK v1.2 (Level 3)
│   │   ├── Full Web SDK v1.1 (Level 3)
│   │   └── Full Web SDK v1.0 (Level 3)
│   ├── Lite Web SDK (Level 2)
│   │   ├── Lite Web SDK v1.2 (Payment) (Level 3)
│   │   ├── Lite Web SDK v1.1 (Payment) (Level 3)
│   │   ├── Lite Web SDK (Enrollment) (Level 3)
│   │   └── Lite Web SDK v1.3 (Payment) (Level 3)
│   ├── Secure Fields (Web) (Level 2)
│   │   ├── Secure Fields (Payment) (Level 3)
│   │   └── Secure Fields (Enrollment) (Level 3)
│   ├── Headless Web SDKs (Level 2)

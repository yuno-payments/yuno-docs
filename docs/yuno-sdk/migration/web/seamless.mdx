...
|---|---|---|
| `yuno.startSeamlessCheckout(config)` | `sdkPayments.transaction(config)` | Single factory. Don't wire `createPayment`, as that would flip to manual mode (non-Seamless behavior). |

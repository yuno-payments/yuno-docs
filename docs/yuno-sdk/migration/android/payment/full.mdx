...
|---|---|---|
| `callbackPaymentState: (state, subState) -> Unit` | `onStatus(status: PaymentStatus)` | `"CANCELED_BY_USER"` renamed to `"USER_CANCELLED"`. See [Result mapping in Lite](/docs/yuno-sdk/migration/android/payment/lite#result-mapping). |

...
<GenericOrientation />
Follow this step-by-step guide to implement and enable Yuno's Lite iOS SDK enrollment capability in your app.

## Step 1: Include the library in your project

Before proceeding with the Lite SDK implementation, see the [Quickstart Guide](/docs/sdks/overview/quickstart) for detailed instructions on how to properly integrate the SDK into your project. It supports both CocoaPods and Swift Package Manager.

...
| `updateCheckoutSession` | Method to inject a new checkout session without unmounting the SDK. Use it to switch payment methods after a failure. See [updateCheckoutSession](/docs/sdks/resources/references/web#updatecheckoutsession) for details. |

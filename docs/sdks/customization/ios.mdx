...
| Field                            | Description                                                                                                                            |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `fontFamily`                     | Specifies the font family used in the SDK. Provide the font filename used in your app, ensuring it matches your app's assets. |
...
| `disableButtonBackgroundColor`   | Sets the background color for buttons that are off.                                                                                     |
| `disableButtonTitleColor`        | Determines the text color for buttons that are off.                                                                                    |
...
<Image border={false} src="https://files.readme.io/47e26ec-image.png" alt="Two example checkout screens showing different accent colors" />

## Address autocomplete

Merchants can turn address autocomplete capability on or off in the iOS SDK. When it's on, the SDK automatically fills address fields based on postal code lookup. When it's off, users must manually enter all address information.
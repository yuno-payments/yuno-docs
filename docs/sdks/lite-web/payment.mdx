...
| `yunoPaymentResult`         | Callback called after the payment is completed, with the [payment status](/reference/getting-started/response-codes) (e.g., `SUCCEEDED`, `DECLINED`, `PENDING`, `ERROR`) and an optional `subStatus` qualifying it. See [Shopper-cancelled steps](/docs/sdks/resources/references/web#shopper-cancelled-steps).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

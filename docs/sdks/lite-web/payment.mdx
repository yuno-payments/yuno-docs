...
See the [Payment type](/reference/reference-lists/payment-type-list) page to view the complete list of payment method types you can use when mounting the SDK.

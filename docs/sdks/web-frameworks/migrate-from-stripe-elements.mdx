...
The one structural difference: on Yuno the payment is always created from your server, never from the browser. That keeps your private key off the client and gives your backend the payment id before any redirect happens.

...
For comprehensive testing with Yuno Testing Gateway, use the official test cards documented at [Yuno Testing Gateway](/docs/direct-integration-use-cases/yuno-testing-gateway). The canonical Visa success card is `4507990000000002`. The cards below are convenience placeholders for this quickstart.
</Warning>

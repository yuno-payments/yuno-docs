...
<iframe
  src="/images/reference/understanding-payment-and-enrollment-flows/diagrams/full-checkout-flow.html"
  width="100%"
  height="546px"
  frameBorder="0"
...
<iframe
  src="/images/reference/understanding-payment-and-enrollment-flows/diagrams/payment-flow-using-vaulted-token.html"
  width="100%"
  height="579px"
  frameBorder="0"
  style={{ borderRadius: "12px", overflow: "hidden" }}
...
<iframe
  src="/images/reference/understanding-payment-and-enrollment-flows/diagrams/payment-method-enrollment-flow.html"
  width="100%"
  height="599px"
  frameBorder="0"
  style={{ borderRadius: "12px", overflow: "hidden" }}

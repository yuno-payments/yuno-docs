...
<iframe src="/diagrams/sdks/overview/understanding-flows/full-checkout-flow.html" style={{ width: "100%", aspectRatio: "1600 / 874" }} frameBorder="0" allow="fullscreen" allowFullScreen></iframe>
...
<iframe src="/diagrams/sdks/overview/understanding-flows/payment-flow-using-vaulted-token.html" style={{ width: "100%", aspectRatio: "1510 / 874" }} frameBorder="0" allow="fullscreen" allowFullScreen></iframe>
...
<iframe src="/diagrams/sdks/overview/understanding-flows/payment-method-enrollment-flow.html" style={{ width: "100%", aspectRatio: "1460 / 874" }} frameBorder="0" allow="fullscreen" allowFullScreen></iframe>

...
For styling, themes, form options, and additional configurations, see [SDK customizations](/docs/sdks/resources/references/web). [Changelog](/changelog/web-sdk-v13-changelog).

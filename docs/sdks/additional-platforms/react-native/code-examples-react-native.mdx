---
title: Code Examples
description: "Ready-to-use React Native SDK code examples for common payment scenarios."
deprecated: false
hidden: true
metadata:
  robots: index
...
| `countryCode` | ISO country code for the payment (e.g. `US`). See [Country coverage](/docs/sdks/resources/country-coverage). |

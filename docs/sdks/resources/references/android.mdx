...
description: "Reference for parameters, customizations, and advanced features across Android SDK flows."
deprecated: false
hidden: false
metadata:
  robots: index
...
| `keepLoader`       | boolean | No       | When `true`, the SDK loader remains visible after the payment is initiated. Use for consistent UI during external redirects or long polling.                                                                                                                               |

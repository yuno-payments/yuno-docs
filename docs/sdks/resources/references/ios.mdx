...
| `YunoConfig`               | YunoConfig       | No       | Same options as payment (for example, `appearance`, `saveCardEnabled`, `keepLoader`). See the preceding [YunoConfig options (initialize)](#yunoconfig-options-initialize). |

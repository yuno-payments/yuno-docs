...
> 
> Only payments with **PENDING** status can be canceled. Check the [Payment status](doc:payments-1) page for further details regarding the possible payment status.

...
next:
  description: ''
---
On this page, you will find a walk-through guide on enrolling a payment method and creating a payment. You can check the **XXXXXX** *(Currently, we don't have such a page. Is this information available so we can use it to create a reference page?)* page to know which payments require enrollment by the customer before the payment creation.

...
- <ChangelogBadge type="added" /> **Revolut Pay Support**  
  Native support for Revolut Pay has been added for iOS 15 and above, available through CocoaPods.

- <ChangelogBadge type="changed" /> **Payment Screen Copy Update**  
  The payment and enrollment status screen copy has been updated in all supported languages, with clearer default button labels for exit, retry, and returning home.

- <ChangelogBadge type="changed" /> **Instruction Icons Rendering**  
  Improved the rendering of payment instruction icons.

- <ChangelogBadge type="changed" /> **Native Antifraud Modules**  
  ClearSale and Koin antifraud fingerprinting now activate automatically when their optional modules are added to the app.

## v2.24.1
*September 15, 2026*

- <ChangelogBadge type="fixed" /> **Bug Fixes and Stability**  
  Improved the stability of the payment screen.

## v2.24.0
*September 4, 2026*

- <ChangelogBadge type="added" /> **Apple Pay Shipping Callbacks**  
  New optional callbacks allow updates to the payment sheet based on shipping methods and addresses, enhancing the Apple Pay integration experience.

- <ChangelogBadge type="changed" /> **Form Field Sizes**  
  Increased input field height and text size for improved user interaction and readability.

- <ChangelogBadge type="removed" /> **Helper Text in Payment Forms**  
  The introductory text is removed from alternative payment method forms, streamlining the layout and eliminating unnecessary space.

## v2.23.1
*August 27, 2026*

- <ChangelogBadge type="fixed" /> **Maintenance Release**  
  Maintenance release with internal improvements.

## v2.23.0
*August 26, 2026*

- <ChangelogBadge type="added" /> **Structured Error Messages**  
  Added an optional structured error message for internal-error and declined/rejected statuses, including source, code, and reason.

## v2.22.0
*August 11, 2026*

- <ChangelogBadge type="changed" /> **Powered by Yuno Badge**  
  Redesigned to include the official Yuno wordmark and a localized "Privacy" link that opens in an in-app browser. The badge is displayed below the payment-methods list and render-mode forms, but can be hidden using an opt-in setting.

- <ChangelogBadge type="removed" /> **Inline Privacy Disclosure**  
  The inline "By paying, you agree to the Personal Data Processing Policy" statement has been removed from all payment forms. The privacy notice is now only next to the Powered by Yuno badge.

- <ChangelogBadge type="added" /> **Privacy Badge Telemetry**  
  When the badge is shown, telemetry reports the display for backend consent records. No reporting occurs when the badge is hidden.

- <ChangelogBadge type="removed" /> **Legacy Asset**  
  The unused legacy Yuno logo asset has been removed from the SDK asset catalog.

- <ChangelogBadge type="added" /> **ACH Direct Debit Fields**  
  Account type and Account holder type dropdowns have been added to the ACH Direct Debit forms, collected when marked as required in the checkout session.

- <ChangelogBadge type="changed" /> **Payment Method Selection**  
  The payment method selection radio button has been moved to the leading edge of the row and is now RTL-aware.

- <ChangelogBadge type="changed" /> **Unfolded Forms for APMs**  
  Alternative Payment Methods (APMs) now support inline forms that render under the selected payment method instead of a separate screen. Click to Pay and Apple Pay flows remain unchanged.

- <ChangelogBadge type="added" /> **Address Autofill**  
  Customers can now search for and select their address to automatically populate billing and shipping forms.

- <ChangelogBadge type="added" /> **Netcetera 3DS Authentication**  
  Support for Netcetera native 3DS authentication during card enrollment, aligning with the existing payment flow.

## v2.21.2
*August 4, 2026*

- <ChangelogBadge type="changed" /> **One-Time Token Creation**  
  All fields in the headless `detail` object are now optional.

## v2.21.1
*July 28, 2026*

- <ChangelogBadge type="fixed" /> **Saved-Card Checkout Behavior**  

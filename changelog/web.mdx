...
- <ChangelogBadge type="changed" /> **PayPal enrollment: avoid double error handling when the payment lookup fails after approval — the error screen or merchant error callback now fires exactly once, honoring showPaymentStatus.**  

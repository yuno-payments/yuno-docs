...
- <ChangelogBadge type="fixed" /> **PayPal Enrollment button no longer hidden or stuck on stale sessions**  
...
- <ChangelogBadge type="added" /> **Venmo button on the PayPal v6 express button**  
...
- <ChangelogBadge type="changed" /> **Yuno Pay Button in the Enrollment Flow**  
...
- <ChangelogBadge type="added" /> **Apple Pay Card Acceptance Filters**  
...
- <ChangelogBadge type="fixed" /> **Google Pay sheet shows a translated "Total"**  
...
- <ChangelogBadge type="added" /> **Explicit institution number and transit number fields for Canadian PAD**  
...
- <ChangelogBadge type="fixed" /> **Fraud scripts and the Samsung Pay Portuguese button follow the white-label host**  
...
- <ChangelogBadge type="fixed" /> **Fixed False Payment Timeout Error**  
...
- <ChangelogBadge type="fixed" /> **Minimal card form copies are translated in every supported language**  
...
- <ChangelogBadge type="fixed" /> **Card brand icons follow the white-label host**  
...
- <ChangelogBadge type="added" /> **Minimal card form for merchants with card as the only selectable method**  
...
- <ChangelogBadge type="changed" /> **The Full checkout shows its payment methods once, fully loaded**  
...
- <ChangelogBadge type="fixed" /> **Payment Link: the selected payment method follows the Payment Link accent color**  
...
- <ChangelogBadge type="changed" /> **Android phones no longer load Apple Pay resources**  
...
- <ChangelogBadge type="fixed" /> **PayPal Enrollment on JS SDK v6**  
...
- <ChangelogBadge type="fixed" /> **PayPal retry after a failed start**  
...
- <ChangelogBadge type="changed" /> **The PayPal Enrollment button gets its configuration earlier on the Full checkout**  
...
- <ChangelogBadge type="changed" /> **The Google Pay button checks eligibility earlier**  
...
- <ChangelogBadge type="changed" /> **Express buttons load faster inside the Instagram and Facebook apps on Android**  
...
- <ChangelogBadge type="changed" /> **Devices that cannot pay with Apple Pay no longer request its configuration**  
...
- <ChangelogBadge type="fixed" /> **Click to Pay email form is fully translated**  
...
- <ChangelogBadge type="changed" /> **Checkouts with a session request country data once**  
...
- <ChangelogBadge type="fixed" /> **Click to Pay shows the "or" separator in the shopper's language**  
...
- <ChangelogBadge type="changed" /> **Internal logging improvements**  
...
- <ChangelogBadge type="changed" /> **SDK events carry the public SDK version and the retry-chain root from the first attempt**  
...
- <ChangelogBadge type="fixed" /> **checkout.abandoned sends the attributes its contract requires**  
...
- <ChangelogBadge type="added" /> **Granular loading events for progressive checkout rendering**  
...
- <ChangelogBadge type="fixed" /> **Authorization Copy Under the Single Pay Button Sticks to the Selected Method**  
...
- <ChangelogBadge type="fixed" /> **Honor the Keyboard Next Key Across the Card Form Secure Fields**  
...
- <ChangelogBadge type="changed" /> **Load the Unfolded Card Form Without Waiting for Customer Data**  
...
- <ChangelogBadge type="added" /> **Contextual authorization copy for stored payment methods**  
...
- <ChangelogBadge type="changed" /> **Faster Express Buttons in the Full Checkout**  
...
- <ChangelogBadge type="changed" /> **Lighter SDK Boot: Browser Detection Moved Server-Side**  
...
- <ChangelogBadge type="fixed" /> **PayPal JS SDK v6 Support**  
...
- <ChangelogBadge type="changed" /> **Faster, Lighter Card Field Iframes**  
...
- <ChangelogBadge type="fixed" /> **Regional static hosts: chunks and card iframes follow the host the SDK was loaded from**  
...
- <ChangelogBadge type="added" /> **Venmo renders in sandbox for testers outside the US**  
...
- <ChangelogBadge type="fixed" /> **PayPal button container grows with the rendered buttons**  
...
- <ChangelogBadge type="added" /> **PayPal enable-funding support (Venmo)**  
...
- <ChangelogBadge type="fixed" /> **Fixed the expanded payment method list preselecting nothing for returning shoppers**  
...
- <ChangelogBadge type="fixed" /> **Enrollment OTP screen shows the branding of the method being enrolled**  
...
- <ChangelogBadge type="fixed" /> **The ACH account type and account holder type fields offer their options during enrollment**  
...
- <ChangelogBadge type="added" /> **Merchant-configurable ThreatMetrix session_id prefix for Cielo CyberSource**  
...
- <ChangelogBadge type="fixed" /> **Google Pay honours `showPaymentStatus` when the payment fails**  
...
- <ChangelogBadge type="fixed" /> **Fixed Revolut Pay Late Authorization Expiry**  
...
- <ChangelogBadge type="added" /> **PayPal Enrollment Element Render and Customization**  
...
- <ChangelogBadge type="fixed" /> **Merchant Redirects After 3DS No Longer Cancelled**  
...
- <ChangelogBadge type="added" /> **Direct Debit Authorization and Save for Future Payments**  
...
- <ChangelogBadge type="added" /> **Plugin attribution on every SDK event**  
...
- <ChangelogBadge type="changed" /> **Apple Pay capability detection hardened for older Safari**  
...
- <ChangelogBadge type="added" /> **onChange reports whether the payment form is complete**  
...
- <ChangelogBadge type="fixed" /> **Only the selected payment method is submitted, and the loading state always closes**  
...
- <ChangelogBadge type="changed" /> **SDK events renamed to the event taxonomy**  
...
- <ChangelogBadge type="added" /> **Configurable Express Buttons Stacking**  
...
- <ChangelogBadge type="changed" /> **Slimmer Forms sized to Stripe parity**  
...
- <ChangelogBadge type="changed" /> **Default Inter font loads as external woff2 subsets**  
...
- <ChangelogBadge type="added" /> **Accertify Device Fingerprinting Support**  
...
- <ChangelogBadge type="added" /> **Button Links Block in Payment Actions**  
...
- <ChangelogBadge type="fixed" /> **White-Label Embedded 3DS Challenge Completion**  
...
- <ChangelogBadge type="added" /> **Portuguese Samsung Pay button via locale-based asset override**  
...
- <ChangelogBadge type="changed" /> **Enrollment sends each bank transfer field on its own**  
...
- <ChangelogBadge type="fixed" /> **Third-party script error watchers no longer replace window.onerror**  
...
- <ChangelogBadge type="changed" /> **Faster Lite and External Buttons Loading**  
...
- <ChangelogBadge type="fixed" /> **Fixed SEPA Enrollment Bank Details**  
  Enrollment only sent the account number, beneficiary name and routing number when all three were filled in, so methods that do not ask for a routing number (SEPA Direct Debit) lost the other two. Each field is now sent whenever it has a value.
...
- <ChangelogBadge type="fixed" /> **Honor the Keyboard Next Key Across the Card Form Fields**  
...
- <ChangelogBadge type="fixed" /> **Hebrew and Persian RTL in the Card Form**  
...
- <ChangelogBadge type="fixed" /> **`three_ds.completed` now reports the 3DS outcome instead of the payment outcome**  

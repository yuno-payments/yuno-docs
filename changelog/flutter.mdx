...
- <ChangelogBadge type="changed" /> **Android SDK Update**  
  Updated the native Android SDK to version 2.22.0.

- <ChangelogBadge type="changed" /> **iOS SDK Update**  
  Updated the native iOS SDK to version 2.23.1.

- <ChangelogBadge type="added" /> **Payment Status Message and Substatus**  
  Payment and enrollment results now expose a status message (source, code, reason) and a substatus with more detail about the outcome.

## v1.0.18

- <ChangelogBadge type="changed" /> **Native Android SDK Update**  
  Updated the native Android SDK to version 2.21.1.

- <ChangelogBadge type="changed" /> **Native iOS SDK Update**  
  Updated the native iOS SDK to version 2.21.2.

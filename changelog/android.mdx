...
- <ChangelogBadge type="added" /> **Feedback when Pay is pressed without a payment method**  
  Pay without a selected method now highlights the list instead of opening the checkout; without the list on screen, callbackPaymentState gets INTERNAL_ERROR with code PAYMENT_METHOD_NOT_SELECTED.

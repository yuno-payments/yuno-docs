...
description: "Reference every report type and its available fields with data origin and availability."
---
...
* [Payment](/reference/reports-fields#payment-report)
* [Transaction ](/reference/reports-fields#transaction-report)
* [Reconciliation Overview](/reference/reports-fields#reconciliation-overview)
* [Settlements & Fees](/reference/reports-fields#settlements--fees)
* [Communications](/reference/reports-fields#communications-report)
* [Fraud Transactions](/reference/reports-fields#fraud-transactions-report)
* [Payouts](/reference/reports-fields#payouts-report)
* [Fees](/reference/reports-fields#fees-report)
* [Cashflow (Agenda)](/reference/reports-fields#cashflow-agenda)
* [Advancements](/reference/reports-fields#advancements-report)
...
<Accordion title="Payment report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><code>{`[{"key":"order_ref","value":"20260100186943"}]`}</code></td>
            </tr>
            <tr>
...
<Accordion title="Transaction report field details">
  <table>
    <thead>
      <tr>
        <th>Parameter</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><code>{`{"value":"{\"country\":\"Colombia\",\"ticketNumber\":\"...\"}"}`}</code></td>
      </tr>
      <tr>
        ...
        <td><code>{`{"value":"{\"bankId\":\"1051\",\"bankName\":\"BANCO DAVIVIENDA\"}"}`}</code></td>
      </tr>
      <tr>
...
<Accordion title="Reconciliation Overview field details">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>5104911d-5df9-229e-8468-bd41abea1a4b</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>2026-02-03T22:21:03.000Z</td>
    </tr>
    <tr>
      <td><code>updated_at</code></td>
      <td>timestamp</td>
      <td>The date and time from the last time the transaction was updated (ISO 8601).</td>
      <td>2026-02-03T22:40:17.000Z</td>
    </tr>
    <tr>
      <td><code>reconciliation_date</code></td>
      <td>date</td>
      <td>The date the transaction was reconciled (MAX 27; MIN 27; ISO 8601).</td>
      <td>2026-02-09</td>
    </tr>
    <tr>
      <td><code>reconciliation_settlement_date</code></td>
      <td>date</td>
      <td>Date by the acquirer on which the funds will be deposited in the merchant's bank account.</td>
      <td>2026-02-09</td>
    </tr>
    <tr>
      <td><code>estimated_settlement_date</code></td>
      <td>date</td>
      <td>Date on which the funds are expected to be deposited to the merchant.</td>
      <td>2026-02-09</td>
    </tr>
    <tr>
      <td><code>provider_id</code></td>
    ...
    <tr>
      <td><code>amount</code></td>
      <td>decimal</td>
      <td>The amount of the transaction in the original currency.</td>
      <td>100.00</td>
    </tr>
    <tr>
      <td><code>currency</code></td>
    ...
    <tr>
      ...
      <td>decimal</td>
      <td>Transaction amount expressed in the local currency of the merchant (multiple of 0.0001).</td>
      <td>1000.00</td>
    </tr>
    <tr>
      <td><code>net_amount</code></td>
      <td>decimal</td>
      <td>Net amount after fees and taxes in the original currency (multiple of 0.0001).</td>
      <td>970.00</td>
    </tr>
    <tr>
      <td><code>settlement_gross_amount</code></td>
      <td>decimal</td>
      <td>Gross transaction amount in the settlement currency (multiple of 0.0001).</td>
      <td>100.00</td>
    </tr>
    <tr>
      <td><code>settlement_fees</code></td>
      <td>decimal</td>
      <td>Total commission fee withheld by the acquirer in the settlement currency (multiple of 0.0001).</td>
      <td>15.00</td>
    </tr>
    <tr>
      <td><code>settlement_net_credit</code></td>
      <td>decimal</td>
      <td>Credit amount minus fees in the settlement currency (multiple of 0.0001).</td>
      <td>970.00</td>
    </tr>
    <tr>
      <td><code>local_retention</code></td>
      <td>decimal</td>
      <td>Local tax retention applied to the transaction (multiple of 0.0001).</td>
      <td>0.25</td>
    </tr>
    <tr>
      <td><code>local_tax</code></td>
      <td>decimal</td>
      <td>Local taxes applied to the transaction (multiple of 0.0001).</td>
      <td>0.50</td>
    </tr>
    <tr>
      <td><code>provider_fee_taxes</code></td>
      <td>decimal</td>
      <td>Taxes on provider-level fees in the original currency (multiple of 0.0001).</td>
      <td>0.10</td>
    </tr>
    <tr>
      <td><code>provider_fees</code></td>
      <td>decimal</td>
      <td>Fees retained by the provider in the original currency (multiple of 0.0001).</td>
      <td>10.00</td>
    </tr>
    <tr>
      <td><code>status</code></td>
    ...
    <tr>
      <td><code>type</code></td>
      <td>enum</td>
      <td>The transaction type. Possible values: PURCHASE, REFUND, CHARGEBACK (MAX 255; MIN 3).</td>
      <td>PURCHASE</td>
    </tr>
    <tr>
      <td><code>reconciliation_status</code></td>
      <td>enum</td>
      <td>The reconciliation status of a transaction. Possible values: RECONCILED, NOT_RECONCILED, CONFLICT, NON_RECONCILABLE (MAX 255; MIN 3).</td>
      <td>RECONCILED</td>
    </tr>
    <tr>
      <td><code>reconciliation_sub_status</code></td>
      <td>enum</td>
      <td>The reconciliation substatus of a transaction. Possible values: AUTOMATICALLY, MANUAL, PENDING (MAX 255; MIN 3).</td>
      <td>AUTOMATICALLY</td>
    </tr>
    <tr>
      <td><code>payment_method_category</code></td>
      <td>enum</td>
      <td>Category of the transaction (e.g. CARD, WALLET, BANK_TRANSFER) (MAX 255; MIN 3).</td>
      <td>CARD</td>
    </tr>
    <tr>
      <td><code>payment_method_type</code></td>
    ...
    <tr>
      <td><code>card_brand</code></td>
      <td>enum</td>
      <td>The card's brand information standardized by Yuno (MAX 255; MIN 3).</td>
      <td>MASTERCARD</td>
    </tr>
    <tr>
      <td><code>provider_card_brand</code></td>
      <td>string</td>
      <td>The payment method or card brand as reported by the provider (MAX 255; MIN 3).</td>
      <td>MASTERCARD</td>
    </tr>
    <tr>
      <td><code>card_category</code></td>
    ...
    <tr>
      <td><code>card_type</code></td>
      <td>enum</td>
      <td>The type of the card's issuer. Possible values: CREDIT, DEBIT (MAX 255; MIN 3).</td>
      <td>CREDIT</td>
    </tr>
    <tr>
      <td><code>card_iin</code></td>
      <td>string</td>
      <td>The issuer identification number (IIN) of the payment card. Stored as string to preserve leading zeros (MAX 8; MIN 6).</td>
      <td>411111</td>
    </tr>
    <tr>
      <td><code>card_lfd</code></td>
    ...
    <tr>
      <td><code>card_issuer_country</code></td>
      <td>enum</td>
      <td>Country of the card issuer (MAX 2; MIN 2; ISO 3166-1).</td>
      <td>US</td>
    </tr>
    <tr>
      <td><code>card_issuer_name</code></td>
    ...
    <tr>
      <td><code>description</code></td>
      <td>string</td>
      <td>Free-text description of the transaction provided by the merchant.</td>
...
<Accordion title="Settlements & Fees field details">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
  ...
  <tbody>
    ...
    <tr>
      <td><code>payment_id</code></td>
      <td>string</td>
      <td>The unique identifier of the payment (MAX 64; MIN 36). A payment may group several transactions (e.g. PURCHASE plus REFUND).</td>
      <td>5104911d-5df9-229e-8468-bd41abea1a4b</td>
    </tr>
    <tr>
      <td><code>reconciliation_id</code></td>
    ...
    <tr>
      <td><code>settlement_batch_id</code></td>
      <td>string</td>
      <td>Unique acquirer settlement batch number that you can find on your bank statement for the corresponding deposit (MAX 255; MIN 3).</td>
    ...
    <tr>
      <td><code>organization_code</code></td>
      <td>string</td>
      <td>Unique identifier of the organization associated with the transaction (MAX 64; MIN 3).</td>
      <td>ORG_ABC_001</td>
    </tr>
    <tr>
      <td><code>customer_id</code></td>
    ...
    <tr>
      <td><code>merchant_order_id</code></td>
      <td>string</td>
      <td>Identification of the order assigned by the merchant (MAX 255; MIN 3).</td>
      <td>ORDER-abc123456789</td>
    </tr>
    <tr>
      <td><code>merchant_transaction_id</code></td>
    ...
    <tr>
      <td><code>provider_merchant_id</code></td>
      <td>string</td>
    ...
    <tr>
      ...
      <td>timestamp</td>
      <td>Transaction creation date (MAX 27; MIN 27; ISO 8601).</td>
      <td>2026-01-29T20:56:25.000Z</td>
    </tr>
    <tr>
      <td><code>settlement_date</code></td>
      <td>date</td>
      <td>Date the funds were settled to the merchant account.</td>
      <td>2026-02-03</td>
    </tr>
    <tr>
      <td><code>reconciliation_date</code></td>
      <td>date</td>
      <td>The date the transaction was reconciled.</td>
      <td>2026-01-21</td>
    </tr>
    <tr>
      <td><code>estimated_settlement_date</code></td>
    ...
    <tr>
      <td><code>provider_id</code></td>
      <td>enum</td>
      <td>Identifier of the provider / gateway that processed the transaction.</td>
      <td>PROVIDER_ABC</td>
    </tr>
    <tr>
      <td><code>provider_transaction_id</code></td>
      <td>string</td>
      <td>The unique identifier of the transaction assigned by the gateway. This field is empty if the gateway does not provide transaction information (MAX 255; MIN 3).</td>
      <td>53443e9c-dd17-11ec-9d64-0242ac120002</td>
    </tr>
    <tr>
      <td><code>authorization_code</code></td>
      <td>string</td>
      <td>In case of a card transaction, the code assigned by the issuing bank to the transaction when it is authorized. Empty if the gateway does not provide it (MAX 255; MIN 3).</td>
      <td>123456</td>
    </tr>
    <tr>
      <td><code>type</code></td>
    ...
    <tr>
      <td><code>currency</code></td>
      <td>enum</td>
      <td>Currency code in which the original transaction was made (MAX 3; MIN 3; ISO 4217).</td>
      <td>USD</td>
    </tr>
    <tr>
      <td><code>settlement_currency</code></td>
      <td>enum</td>
      <td>Currency code in which the settlement was made (MAX 3; MIN 3; ISO 4217).</td>
      <td>USD</td>
    </tr>
    <tr>
      <td><code>gross_credit</code></td>
      <td>decimal</td>
      <td>For credit transactions, the corresponding gross amount in the original currency (multiple of 0.0001).</td>
      <td>1000.00</td>
    </tr>
    <tr>
      <td><code>gross_debit</code></td>
      <td>decimal</td>
      <td>For debit transactions (refunds, chargebacks), the corresponding gross amount in the original currency (multiple of 0.0001).</td>
      <td>200.00</td>
    </tr>
    <tr>
      <td><code>settlement_gross_amount</code></td>
    ...
    <tr>
      ...
      <td>decimal</td>
      <td>The amount submitted in the debit transaction requests minus acquirer fees in settlement currency (multiple of 0.0001).</td>
      <td>190.00</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>net_amount</code></td>
      <td>decimal</td>
      <td>Net amount in the original currency after fees and taxes (multiple of 0.0001).</td>
      <td>970.00</td>
    </tr>
    <tr>
      <td><code>settlement_fees</code></td>
    ...
    <tr>
      <td><code>local_tax</code></td>
      <td>decimal</td>
      <td>Local taxes applied to the transaction in local currency (multiple of 0.0001).</td>
      <td>0.50</td>
    </tr>
    <tr>
      <td><code>local_retention</code></td>
      <td>decimal</td>
      <td>Local tax retention applied to the transaction in local currency (multiple of 0.0001).</td>
      <td>0.25</td>
    </tr>
    <tr>
      <td><code>provider_fee_taxes</code></td>
    ...
    <tr>
      <td><code>payment_method_type</code></td>
      <td>enum</td>
      <td>The type of payment method selected by the customer (e.g. VI, MD, PIX, BOLETO) (MAX 255; MIN 3).</td>
      <td>VI</td>
    </tr>
    <tr>
      <td><code>card_brand</code></td>
      <td>enum</td>
      <td>Brand of the card used in the transaction (e.g. VISA, MASTERCARD, AMEX) (MAX 255; MIN 3).</td>
      <td>VISA</td>
    </tr>
    <tr>
      <td><code>card_type</code></td>
      <td>enum</td>
      <td>Type of card used in the transaction. Possible values: CREDIT, DEBIT (MAX 7; MIN 5).</td>
      <td>CREDIT</td>
    </tr>
    <tr>
      <td><code>card_iin</code></td>
      <td>string</td>
      <td>The issuer identification number (IIN), i.e. the first digits of the payment card. Stored as string to preserve leading zeros (MAX 8; MIN 6).</td>
      <td>411111</td>
    </tr>
    <tr>
      <td><code>card_lfd</code></td>
      <td>string</td>
      <td>Last four digits of the payment card (MAX 4; MIN 4).</td>
      <td>7890</td>
    </tr>
    <tr>
      <td><code>installments</code></td>
    ...
    <tr>
      <td><code>country</code></td>
      <td>enum</td>
      <td>Country of the merchant account (MAX 2; MIN 2; ISO 3166-1).</td>
      <td>US</td>
    </tr>
  </tbody>
</table>
...
<Accordion title="Communications report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
...
<Accordion title="Fraud Transactions report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
...
<Accordion title="Payouts report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
...
<Accordion title="Fees report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
...
The Cashflow report (also known as the Agenda) shows transactions that have been processed and are scheduled to be settled in the future. It lets you anticipate incoming funds. Advancements (early payouts) are excluded so the view reflects only the upcoming settlements you are still entitled to receive.

<Accordion title="Cashflow (Agenda) field details">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>number</td>
      <td>Current installment number being settled (MAX 6; MIN 3).</td>
      <td>1</td>
    </tr>
    <tr>
      <td><code>payment_method_category</code></td>
    ...
    <tr>
      ...
      <td>string</td>
      <td>Bank code where the merchant receives the settlement.</td>
      <td>0237</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>string</td>
      <td>Bank agency / branch details for the transaction.</td>
      <td>12</td>
    </tr>
    <tr>
      <td><code>customer_id</code></td>
    ...
    <tr>
      <td><code>provider_fees</code></td>
      <td>decimal</td>
      <td>Fees charged by the provider in the original currency (multiple of 0.0001).</td>
      <td>0.86</td>
    </tr>
    <tr>
      <td><code>provider_id</code></td>
    ...
    <tr>
      ...
      <td>date</td>
      <td>Intended settlement date originally informed by the provider.</td>
      <td>2026-06-11</td>
    </tr>
    <tr>
      <td><code>response_code</code></td>
    ...
    <tr>
      ...
      <td>01027058000191047408760001...</td>
    </tr>
    <tr>
      <td><code>provider_status</code></td>
      <td>enum</td>
    ...
    <tr>
      ...
      <td>timestamp</td>
      <td>Timestamp when the transaction was last updated (ISO 8601).</td>
      <td>2026-05-11T11:33:52.000Z</td>
    </tr>
    <tr>
      <td><code>advancement_amount</code></td>
      <td>decimal</td>
      <td>Amount advanced for the transaction (multiple of 0.0001). Zero when no advancement has been applied.</td>
      <td>0.00</td>
    </tr>
    <tr>
      <td><code>card_type</code></td>
      <td>enum</td>
      <td>Type of card used. Possible values: CREDIT, DEBIT.</td>
      <td>CREDIT</td>
    </tr>
    <tr>
      <td><code>currency</code></td>
    ...
    <tr>
      ...
      <td>timestamp</td>
      <td>Timestamp when the transaction was created (ISO 8601).</td>
      <td>2026-05-11T18:33:50.000Z</td>
    </tr>
    <tr>
      <td><code>merchant_order_id</code></td>
      <td>string</td>
    ...
    <tr>
      ...
      <td>date</td>
      <td>Date on which the provider confirmed the transaction.</td>
      <td>2026-05-12</td>
    </tr>
    <tr>
      <td><code>transaction_id</code></td>
    ...
    <tr>
      ...
      <td>enum</td>
      <td>The type of transaction. Possible values: PURCHASE, REFUND, CHARGEBACK.</td>
      <td>PURCHASE</td>
    </tr>
  </tbody>
</table>
...
The advancements report tracks early payouts, i.e. cases where the provider settles funds before the originally scheduled date (common in Brazil). Use it to monitor which receivables were advanced, the negotiation fees applied and the impact on your cashflow versus the original settlement plan.

<Accordion title="Advancements report field details">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
  ...
  <tbody>
    <tr>
      ...
      <td>string</td>
      <td>Unique identifier for the advancement (early payout) operation (MAX 64; MIN 36).</td>
      <td>69ad0a39-b769-423c-b223-d7b8bf9a1c2d</td>
    </tr>
    <tr>
      <td><code>merchant_id</code></td>
      <td>string</td>
      <td>Unique identifier of the merchant (MAX 64; MIN 36).</td>
      <td>64143128-dd12-11ec-9d64-0242ac120002</td>
    </tr>
    <tr>
      <td><code>organization_code</code></td>
      <td>string</td>
      <td>Unique identifier of the organization associated with the operation (MAX 64; MIN 3).</td>
      <td>ORG_ABC_001</td>
    </tr>
    <tr>
      <td><code>product_id</code></td>
      <td>string</td>
      <td>Unique identifier for the product or receivables agreement linked to the advancement (MAX 64; MIN 36).</td>
      <td>f4c53557-a832-44e9-94e4-0344f91e9d4f</td>
    </tr>
    <tr>
      <td><code>ur_key</code></td>
      <td>string</td>
      <td>Unique reference key tying the advancement to the underlying receivable (MAX 255; MIN 3).</td>
      <td>UR123456789</td>
    </tr>
    <tr>
      <td><code>operation_type</code></td>
      <td>enum</td>
      <td>Type of advancement operation. Possible values: ADVANCE, REFUND.</td>
      <td>ADVANCE</td>
    </tr>
    <tr>
      <td><code>movement_type</code></td>
      <td>enum</td>
      <td>Type of movement for the advancement. Possible values: CREDIT, DEBIT.</td>
      <td>CREDIT</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>date</td>
      <td>Date when the advancement operation was settled to the merchant.</td>
      <td>2026-04-16</td>
    </tr>
    <tr>
      <td><code>ur_operation_date</code></td>
      <td>date</td>
      <td>Date of the underlying UR (receivable) operation.</td>
      <td>2026-04-15</td>
    </tr>
    <tr>
      <td><code>ur_original_settlement_date</code></td>
      <td>date</td>
      <td>Original scheduled settlement date for the underlying receivable, before the advancement.</td>
      <td>2026-05-20</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>decimal</td>
      <td>Gross amount for the underlying UR operation (multiple of 0.0001).</td>
      <td>1000.00</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>string</td>
      <td>The unique identifier of the settlement account that received the advancement (MAX 64; MIN 36).</td>
      <td>64143128-dd12-11ec-9d64-0242ac120002</td>
    </tr>
  </tbody>
</table>

...
* [Transaction reconciliation](/reference/reports-fields#transaction-reconciliation-report)
* [Settlement](/reference/reports-fields#settlement-report)
...
* [Agenda](/reference/reports-fields#agenda-report)
* [Sales Conciliation](/reference/reports-fields#sales-conciliation-report)
...
<Accordion title="Transaction reconciliation report field details">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
...
<Accordion title="Settlement report field details - Header">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
...
<Accordion title="Settlement report field details - Body">
<table>
  <thead>
    <tr>
      <th>Parameter</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td>
        In case of a card transaction, the code assigned by the issuing bank to the transaction when it is
...
<Accordion title="Agenda report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>
...
<Accordion title="Sales Conciliation report field details">
        <table>
          <thead>
            <tr>
              <th>Parameter</th>

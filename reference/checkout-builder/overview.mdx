...
All examples in this reference use the production base URL. The sandbox host accepts the same endpoints and payload shapes — confirm the exact sandbox URL with your Yuno TAM.

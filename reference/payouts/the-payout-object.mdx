...
<ParamField body="status" type="enum">
  ...
  Possible enum values: Check the <a href="/reference/payouts/payout-workflow">Payout Status</a> page.
</ParamField>
...
<ParamField body="withdrawal_method" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="vaulted_token" type="string">
      The vaulted_token represents a securely stored payment_method. Mainly for credit/debit cards in Payouts.

      Example: 41032411-5df9-429e-1238-ad41abea1cf6
    </ParamField>

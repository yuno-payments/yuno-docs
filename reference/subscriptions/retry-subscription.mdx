...
openapi: "/openapi/subscriptions/retry-subscription.json POST /subscriptions/{subscription_id}/retry"
...
* If neither condition is met, an **INVALID_STATE** error is returned.

...
Yuno sends webhook notifications to your configured endpoint for the following events. For general webhook setup, delivery behavior, and retry logic, see [Events and Triggers](/docs/webhooks/events#banking-connectivity).
...
Incoming transfer notifications are sent to your endpoint at `{merchant_base_URL}/v1/banking/transfers`. See [Webhook Notifications](/reference/banking-connectivity/webhooks/webhook-notifications-banking) for the payload structure.

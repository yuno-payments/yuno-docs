---
title: "Wallet"
description: "Example create-payment requests and responses for wallet payment methods."
---
...
<CardGroup cols={3}>
  <Card title="Mercado Pago Checkout Pro" icon="https://icons.prod.y.uno/mercadopago_logosimbolo.png" href="/reference/payments/payment-examples/wallet#mercado-pago-checkout-pro" />
  <Card title="Astropay" icon="https://icons.prod.y.uno/astropay_logosimbolo.png" href="/reference/payments/payment-examples/wallet#astropay" />
  <Card title="Apple Pay" icon="https://icons.prod.y.uno/applepay_logosimbolo.png" href="#apple-pay" />
  <Card title="Nupay Enrollment" icon="https://icons.prod.y.uno/nupay_logosimbolo.png" href="#nupay-enrollment" />
  <Card title="Nequi" icon="https://icons.prod.y.uno/nequi_logosimbolo.png" href="#nequi" />
...
```json Response (JSON)
{
    ...
    "callback_url": "https://demo.dev.y.uno/testing/checkout/status?checkoutSession=<checkout_session>",

---
title: "BNPL"
description: "Request and response examples for creating BNPL payments using the REDIRECT workflow."
---
...
<CardGroup cols={3}>
  <Card horizontal title="Acuotaz" icon="https://icons.prod.y.uno/acuotaz_logosimbolo.png" href="/reference/bnpl-copy#acuotaz" />
  <Card horizontal title="Addi" icon="https://icons.prod.y.uno/addi_logosimbolo.png" href="/reference/bnpl-copy#addi" />
  <Card horizontal title="Klarna" icon="https://icons.prod.y.uno/klarna_logosimbolo.png" href="/reference/bnpl-copy#klarna" />
  <Card horizontal title="Wibond" icon="https://icons.prod.y.uno/wibond_logosimbolo.png" href="/reference/bnpl-copy#wibond" />
</CardGroup>
</div>

---
title: "Bank Transfer"
description: "Request and response examples for creating bank transfer payments like PIX and PSE."
---
...
<CardGroup cols={3}>
  <Card horizontal title="Bancolombia Button" icon="https://icons.prod.y.uno/bancolombia_logosimbolo.png" href="#bancolombia-button" />
  <Card horizontal title="Daviplata" icon="https://icons.prod.y.uno/daviplata_logosimbolo.png" href="#daviplata" />
  <Card horizontal title="PIX" icon="https://icons.prod.y.uno/pix_logosimbolo.png" href="#pix" />
  <Card horizontal title="PSE" icon="https://icons.prod.y.uno/pse_logosimbolo.png" href="#pse" />
  <Card horizontal title="SafetyPay" icon="https://icons.prod.y.uno/safetypay_logosimbolo.png" href="#safetypay" />
  <Card horizontal title="SPEI" icon="https://icons.prod.y.uno/spei_logosimbolo.png" href="#spei" />
  <Card horizontal title="Codi" icon="https://icons.prod.y.uno/codi_logosimbolo.png" href="#codi" />
  <Card horizontal title="NuPay" icon="https://icons.prod.y.uno/nubank_logosimbolo.png" href="#nupay" />
  <Card horizontal title="Yappy" icon="https://icons.prod.y.uno/yappy_logosimbolo.png" href="#yappy" />
</CardGroup>
</div>

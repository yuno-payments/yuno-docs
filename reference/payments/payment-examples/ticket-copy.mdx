---
title: "Ticket"
description: "Copy ready-made request and response examples for ticket-based payment methods."
---


This page presents examples of requests and responses for creating payments using the [Create Payment](/reference/create-payment) endpoint and Ticket payment methods.
...
<CardGroup cols={3}>
  <Card horizontal title="Arcus" icon="https://icons.prod.y.uno/arcus_logosimbolo.png" href="#arcus" />
  <Card horizontal title="Efecty" icon="https://icons.prod.y.uno/efecty_logosimbolo.png" href="#efecty" />
  <Card horizontal title="Oxxo" icon="https://icons.prod.y.uno/oxxo_logosimbolo.png" href="#oxxo" />
</CardGroup>
</div>

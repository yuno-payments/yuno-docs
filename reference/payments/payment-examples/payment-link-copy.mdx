---
title: "Payment Link"
description: "Request and response examples for creating payment-link payments across providers."
---


This page presents examples of requests and responses for creating payments using the [Create Payment](/reference/create-payment) endpoint and Payment Link as payment method.
...
<CardGroup cols={3}>
  <Card title="Payvalida" icon="https://icons.prod.y.uno/payvalida_logosimbolo.png" href="/reference/payment-link-copy#mercado-pago-checkout-pro" />
  <Card title="Tarjeta Clave" icon="https://icons.prod.y.uno/tarjetaclave_logosimbolo.png" href="/reference/payment-link-copy#tarjeta-clave" />
  <Card title="Webpay" icon="https://icons.prod.y.uno/webpay_logosimbolo.png" href="/reference/payment-link-copy#webpay" />
  <Card title="Pago Efectivo" icon="https://icons.prod.y.uno/pagoefectivo_logosimbolo.png" href="/reference/payment-link-copy#pago-efectivo" />
</CardGroup>

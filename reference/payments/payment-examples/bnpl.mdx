...
<CardGroup cols={3}>
  <Card horizontal title="Acuotaz" icon="https://icons.prod.y.uno/acuotaz_logosimbolo.png" href="/reference/payments/payment-examples/bnpl#acuotaz" />
  <Card horizontal title="Addi" icon="https://icons.prod.y.uno/addi_logosimbolo.png" href="/reference/payments/payment-examples/bnpl#addi" />
  <Card horizontal title="Klarna" icon="https://icons.prod.y.uno/klarna_logosimbolo.png" href="/reference/payments/payment-examples/bnpl#klarna" />
  <Card horizontal title="Wibond" icon="https://icons.prod.y.uno/wibond_logosimbolo.png" href="/reference/payments/payment-examples/bnpl#wibond" />
</CardGroup>
</div>

---
title: "Cards"
description: "Browse request and response examples for creating card payments and authorizations."
---


This page presents examples of requests and responses for creating payments and authorizations using the [Create Payment](/reference/create-payment) endpoint and Card as payment method.
...
<CardGroup cols={3}>
  <Card title="Card Direct for authorization" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-for-authorization" />
  <Card title="Card Direct for authorization with airline data" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-for-authorization-with-airline-data" />
  <Card title="Card Direct with installments" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-with-installments" />
  <Card title="Card Direct with vault on success" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-with-vault-on-success" />
  <Card title="Card Direct with vaulted token" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-with-vaulted-token" />
  <Card title="Card Direct with 3DS" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-with-3ds" />
  <Card title="Card Direct with customer, billing, shipping and order items" icon="https://icons.prod.y.uno/card_logosimbolo.png" href="/reference/cards#card-direct-with-customer-billing-shipping-and-order-items" />
</CardGroup>

  ...
  <Expandable title="properties">
    ...
    <ParamField body="provider_data" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="provider_customer_id" type="string">
          Customer identifier issued by the provider, when the provider returns one. Opaque reference; it is not the Yuno customer id nor `merchant_customer_id`.

          Example: cus_8XPRayxLSKIOwnbd
        </ParamField>

      ...
      <Expandable title="properties">
        ...
        <ParamField body="wallet" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="stored_credentials" type="object">
              Indicates the processing type of the transaction. For an Apple Pay or Google Pay CIT with `vault_on_success`, this is the node to use (`usage: FIRST`); later charges on the resulting `vaulted_token` use `detail.card.stored_credentials`. See [Stored credentials](/docs/payment-features/stored-credentials#wallet-originated-tokens-apple-pay-and-google-pay).

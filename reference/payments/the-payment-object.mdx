...
<ParamField body="applied_promotion" type="object">
  The promotion Yuno applied to this payment. Present only when the payment carried a
  `quote_id` and Yuno applied a promotion; absent (never `null`) otherwise, and the payment
  looks exactly as it does today. `amount.value` is the charged total, and
  `original_amount − discount_amount = charged_amount`, which equals `amount`.
  ...
  <Expandable title="properties">
    ...
    <ParamField body="quote_id" type="string">
      The `quote.id` sent on this payment's `additional_data.order.discounts` entry.
    ...
    <ParamField body="order" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="discounts" type="array of objects">
          ...
          You send `quote_id` on [Create Payment](/reference/payments/create-payment) to ask
          Yuno to apply a promotion quote; it is read back in `applied_promotion.quote_id`. See
          [Promotions](/docs/payment-features/promotions) for the full flow.
          ...
          <Expandable title="properties">
            ...
            <ParamField body="promotion_id" type="string">
              The promotion's id. Present only on the entry Yuno appends when a promotion
              applied.

      ...
      <Expandable title="properties">
        ...
        <ParamField body="bank_transfer" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="institution_number" type="string">
              The financial institution number of a Canadian bank account, for Canadian pre-authorized debit (`PADS`) (MAX 3; MIN 3). Exactly 3 digits. Optional; omitted when it was not provided.

              Example: 002
            </ParamField>

            <ParamField body="transit_number" type="string">
              The transit number of a Canadian bank account, for Canadian pre-authorized debit (`PADS`) (MAX 5; MIN 5). Exactly 5 digits. Optional; omitted when it was not provided.

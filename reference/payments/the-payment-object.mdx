...
<ParamField body="promotion" type="object">
  The promotion Yuno applied to this payment, present only when the payment carried
  `promotion.quote_id` and Yuno applied the quoted promotion; absent (never `null`) otherwise.
  `amount.value` is the charged total, and `original_amount − discount_amount = charge_amount`,
  which equals `amount`. There is no promotion name on the payment: the checkout showed the name on
  the quote. See [Promotions](/docs/payment-features/promotions).
  ...
  <Expandable title="properties">
    ...
    <ParamField body="discount_amount" type="object">
      What the customer saved, always positive.
    ...
    <ParamField body="charge_amount" type="object">
      What the customer paid. Equals the payment's `amount`.
    ...
    <ParamField body="order" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="discounts" type="array of objects">
          Specifies the order's discounts array of objects: informational discounts you sent,
          passed on untouched. Promotion quotes are not sent here; use `promotion.quote_id` on
          [Create Payment](/reference/payments/create-payment). See
          [Promotions](/docs/payment-features/promotions) and
          [Payment amount details](/docs/payment-features/payment-amount-details#discounts).

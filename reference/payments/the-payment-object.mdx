...
<ParamField body="applied_promotion" type="object">
  ...
  `quote_id` and Yuno applied the quoted promotion; absent (never `null`) otherwise, and the
  payment looks exactly as it does today. `amount.value` is the charged total, and
  ...
  <Expandable title="properties">
    ...
    <ParamField body="quote_id" type="string">
      The quote the payment was charged with.

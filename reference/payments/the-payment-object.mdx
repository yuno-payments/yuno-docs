          ...
          <Expandable title="properties">
            ...
            <ParamField body="card_data" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="prepaid" type="boolean">
                  Whether the card BIN range is flagged as prepaid, resolved by Yuno's BIN lookup. Omitted when the BIN is unknown or carries no prepaid data.

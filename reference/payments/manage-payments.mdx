---
title: "Payments"
description: "Overview of the Payments API for creating and managing payments through Yuno."
---
...
<CardGroup cols={3}>
  <Card title="Status and response codes" icon="arrow-up-right-from-square" href="/reference/status-and-response-codes" />

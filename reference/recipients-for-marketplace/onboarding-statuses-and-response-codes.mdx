...
* [Terminate Onboarding](/reference/recipients-for-marketplace/terminate-onboarding)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td class="status"><code>TERMINATED</code></td>
      <td>Permanently terminated by the merchant (e.g., fraud or terms-of-service violation); the account is closed or rejected at the provider. Irreversible through the Yuno API.</td>
      <td class="action">None — create a new recipient and onboarding if the seller should ever be re-onboarded.</td>
    </tr>
  </tbody>
</table>

...
<ParamField body="country" type="enum">
  The recipient's country (MAX 2; MIN 2; <a href="https://en.wikipedia.org/wiki/ISO_3166-1">ISO 3166-1</a> ).
...
<ParamField body="onboardings" type="array of objects">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="status" type="enum">
      ...
      PENDING, SUCCEEDED, DECLINED, BLOCKED, CANCELLED, REJECTED, ERROR
    </ParamField>

...
There are certain objects that are not mandatory when creating a "Customer." However, the more information you provide, the more it can help approval, conversion, and fraud prevention rates.
</Warning>

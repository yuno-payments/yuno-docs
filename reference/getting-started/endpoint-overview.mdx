...
| GET | `/campaigns/{campaign_id}/rules/{rule_id}` |  | — |
| PATCH | `/campaigns/{campaign_id}/rules/{rule_id}` |  | — |
| PATCH | `/campaigns/{campaign_id}/rules/{rule_id}/status` |  | — |
...
| Method | Endpoint | Description | Idempotent |
|--------|----------|-------------|------------|
| GET | `/onboardings/{onboarding_id}/transfers` |  | — |
| POST | `/payments/{payment_id}/transactions/{transaction_id}/split-marketplace/transfer-reversal` |  | Yes |
...
| POST | `/recipients/{recipient_id}/onboardings/{onboarding_id}/transfer` |  | Yes |
| POST | `/recipients/{recipient_id}/onboardings/{onboarding_id}/unblock` | Unblock Recipient | — |
| GET | `/recipients/{recipient_id}/transfers` |  | — |
| POST | `/recipients/onboardings/reverse-transfer/{transfer_id}` |  | Yes |

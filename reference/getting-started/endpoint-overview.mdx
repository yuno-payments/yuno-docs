...
| POST | `/smart-support/external/payments/recover` | Copy of Declined Payment Calls | — |
...
| PATCH | `/checkout/sessions/\{checkout_session\}` | Copy of Create Checkout Session | — |
...
| POST | `/campaigns` | post_campaigns | — |
| GET | `/campaigns/\{campaign_id\}` | get_campaigns-campaign-id | — |
| PATCH | `/campaigns/\{campaign_id\}` | patch_campaigns-campaign-id | — |
| POST | `/campaigns/\{campaign_id\}/rules` | post_campaigns-campaign-id-rules | — |
| GET | `/campaigns/\{campaign_id\}/rules/\{rule_id\}` | get_campaigns-campaign-id-rules-rule-id | — |
| PATCH | `/campaigns/\{campaign_id\}/rules/\{rule_id\}` | patch_campaigns-campaign-id-rules-rule-id | — |
| PATCH | `/campaigns/\{campaign_id\}/rules/\{rule_id\}/status` | patch_campaigns-campaign-id-rules-rule-id-status | — |
...
| PATCH | `/payments/\{payment_id\}/transactions/\{transaction_id\}/dispute` | Copy of Dispute a chargeback | — |
...
| Method | Endpoint | Description | Idempotent |
|--------|----------|-------------|------------|
| GET | `/onboardings/\{onboarding_id\}/transfers` | get_onboardings-onboarding-id-transfers | — |
| POST | `/payments/\{payment_id\}/transactions/\{transaction_id\}/split-marketplace/transfer-reversal` | post_payments-payment-id-transactions-transaction-id-split-marketplace-transfer-reversal | Yes |
...
| POST | `/recipients/\{recipient_id\}/onboardings/\{onboarding_id\}/transfer` | post_recipients-id-onboardings-id-transfer | Yes |
| POST | `/recipients/\{recipient_id\}/onboardings/\{onboarding_id\}/unblock` | Unblock Recipient | — |
| GET | `/recipients/\{recipient_id\}/transfers` | get_recipients-recipient-id-transfers | — |
| POST | `/recipients/onboardings/reverse-transfer/\{transfer_id\}` | post_recipients-id-onboardings-onboarding-reverse-transfer | Yes |
| GET | `/transfers/\{transfer_id\}` | get_transfers-transfer-id | — |

...
Postman is an API platform to help developers design and test APIs. It's an alternative way to make Yuno API requests instead of using the API Reference on Readme.io. [Download Postman](https://www.postman.com/downloads/) for Linux, Windows, or Mac, or use it through your web browser.
...
Access the [Yuno APIs Postman collection](https://documenter.getpostman.com/view/25083296/2sBXikpXDZ?utm_source=slack&utm_medium=link_preview&utm_campaign=other&utm_content=link&utm_term=other#173ba2dd-1dbb-466c-934c-19a4308d9d80).
</Note>

...
<ParamField body="default_price" type="object">
  ...
  <Expandable title="properties">
    <ParamField body="currency" type="enum">
      MAX 3; MIN 3. Must be `USD`  — any other currency is rejected with `400 BAD_REQUEST`.
    </ParamField>

    <ParamField body="value" type="number">
      The price per unit, stored to 4 decimal places — a value with more precision is silently rounded, not rejected.
